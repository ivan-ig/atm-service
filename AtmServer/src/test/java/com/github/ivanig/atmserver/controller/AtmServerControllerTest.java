...
class AtmServerControllerTest {
    ...
    private AtmServerController atmServerController;
    ...
    void init() {
        ...
        atmServerController = new AtmServerControllerImpl(webClient, new AtmService());
    }
    ...
    public void successGetInfoAndBalance() {
        ...
        Mono<ResponseToClient> responseMock =
                atmServerController.getInfoAndBalance("fn", "ln", 16L, 1111);
    ...
    public void successGetInfoAndBalance_invalidPinCode() {
        ...
        Mono<ResponseToClient> responseMock =
                atmServerController.getInfoAndBalance("fn", "ln", 16L, 0);
    ...
    public void failGetInfoAndBalance_notFoundException() {
        ...
        Mono<ResponseToClient> responseMock =
                atmServerController.getInfoAndBalance("wrong", "wrong", 0L, 0);
    ...
    public void failGetInfoAndBalance_UnauthorizedException() {
        ...
        Mono<ResponseToClient> responseMock =
                atmServerController.getInfoAndBalance(anyString(), anyString(), anyLong(), anyInt());
