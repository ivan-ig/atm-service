...
<img height="603" src="C:\Users\usern\OneDrive\Документы\SberSchool\Projects\JavaDeveloperSchool\atm-service\description\structure.png" width="970"/>  

## Модуль atm  
Структура модуля представлена на рисунке:  
<img height="603" src="C:\Users\usern\OneDrive\Документы\SberSchool\Projects\JavaDeveloperSchool\atm-service\description\AtmStructure.png" width="970"/>
...
## Модуль bank-server
Структура модуля представлена на рисунке:  
<img height="603" src="C:\Users\usern\OneDrive\Документы\SberSchool\Projects\JavaDeveloperSchool\atm-service\description\BankServerStructure.png" width="970"/>
### Exception
| Исключение              | Описание                                                                                       |
|-------------------------|------------------------------------------------------------------------------------------------|
